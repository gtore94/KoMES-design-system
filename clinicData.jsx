...
// ──────────────────────────────────────────────────────────────
// 상용 혈자리 (부위별 — on: 자주 쓰는 혈로 선택됨)
// ──────────────────────────────────────────────────────────────
const ACUPOINT_REGIONS = ["상지부", "하지부", "두경부", "흉복부", "요배부"];

const ACUPOINTS = {
  "상지부": [
    { code: "LI004", name: "합곡", on: true }, { code: "LI003", name: "삼간", on: true },
    { code: "HT007", name: "신문", on: true }, { code: "LU006", name: "공최", on: true },
    { code: "LU008", name: "경거", on: true }, { code: "LU007", name: "열결", on: true },
    { code: "LU010", name: "어제", on: true }, { code: "LI001", name: "상양", on: true },
    { code: "LI010", name: "수삼리", on: true }, { code: "LU005", name: "척택", on: true },
    { code: "LI011", name: "곡지", on: true }, { code: "SI008", name: "소해", on: true },
    { code: "PC006", name: "내관", on: true }, { code: "PC008", name: "노궁", on: true },
    { code: "TE005", name: "외관", on: true }, { code: "HT003", name: "소해", on: true },
    { code: "LU011", name: "소상", on: true }, { code: "PC003", name: "곡택", on: true },
    { code: "SI003", name: "후계", on: true }, { code: "HT008", name: "소부", on: true },
    { code: "LI002", name: "이간", on: true }, { code: "GB021", name: "견정", on: false },
    { code: "GB022", name: "연액", on: false }, { code: "GB023", name: "첩근", on: false },
  ],
  "하지부": [
    { code: "BL040", name: "위중", on: true }, { code: "BL060", name: "곤륜", on: true },
    { code: "GB034", name: "양릉천", on: true }, { code: "SP009", name: "음릉천", on: true },
    { code: "BL066", name: "족통곡", on: true }, { code: "SP006", name: "삼음교", on: true },
    { code: "BL057", name: "승산", on: true }, { code: "ST036", name: "족삼리", on: true },
    { code: "SP003", name: "태백", on: true }, { code: "BL067", name: "지음", on: true },
    { code: "ST045", name: "여태", on: true }, { code: "BL036", name: "승부", on: true },
    { code: "LR003", name: "태충", on: true }, { code: "GB044", name: "족규음", on: true },
    { code: "KI003", name: "태계", on: true }, { code: "ST044", name: "내정", on: true },
    { code: "KI001", name: "용천", on: true }, { code: "GB039", name: "현종", on: true },
    { code: "GB041", name: "족임읍", on: true }, { code: "BL056", name: "승근", on: true },
    { code: "ST034", name: "양구", on: true }, { code: "SP010", name: "혈해", on: true },
    { code: "LR001", name: "대돈", on: true }, { code: "BL037", name: "은문", on: false },
  ],
  "두경부": [
    { code: "ST006", name: "협거", on: true }, { code: "ST002", name: "사백", on: true },
    { code: "GB002", name: "청회", on: true }, { code: "TE021", name: "이문", on: true },
    { code: "ST001", name: "승읍", on: true }, { code: "GB001", name: "동자료", on: true },
    { code: "GV020", name: "백회", on: true }, { code: "GB003", name: "상관", on: true },
    { code: "ST007", name: "하관", on: true }, { code: "SI019", name: "청궁", on: true },
    { code: "GB020", name: "풍지", on: true }, { code: "TE023", name: "사죽공", on: true },
    { code: "GV026", name: "수구(인중)", on: true }, { code: "CV024", name: "승장", on: true },
    { code: "BL002", name: "찬죽", on: true }, { code: "BL001", name: "정명", on: true },
    { code: "ST004", name: "지창", on: true }, { code: "BL003", name: "미충", on: false },
    { code: "BL004", name: "곡차", on: false }, { code: "BL005", name: "오처", on: false },
    { code: "BL006", name: "승광", on: false }, { code: "BL007", name: "통천", on: false },
    { code: "BL008", name: "낙각", on: false }, { code: "BL009", name: "옥침", on: false },
  ],
  "흉복부": [
    { code: "CV013", name: "상완", on: true }, { code: "CV010", name: "하완", on: true },
    { code: "CV022", name: "천돌", on: true }, { code: "CV004", name: "관원", on: true },
    { code: "CV006", name: "기해", on: true }, { code: "CV012", name: "중완", on: true },
    { code: "ST025", name: "천추", on: true }, { code: "CV003", name: "중극", on: true },
    { code: "CA001", name: "용함", on: false }, { code: "CA002", name: "적혈", on: false },
    { code: "CA003", name: "신녹두", on: false }, { code: "CA004", name: "흥당", on: false },
    { code: "CA005", name: "폐모", on: false }, { code: "CA006", name: "덕흥", on: false },
    { code: "CA007", name: "소아구흥", on: false }, { code: "CA008", name: "이기문", on: false },
    { code: "CA009", name: "유상", on: false }, { code: "CA010", name: "유방", on: false },
    { code: "CA011", name: "귀문", on: false }, { code: "CA012", name: "직골", on: false },
    { code: "CA013", name: "유하", on: false }, { code: "CA014", name: "마기반", on: false },
    { code: "CA015", name: "설식", on: false }, { code: "CA016", name: "통곡", on: false },
  ],
  "요배부": [
    { code: "BL025", name: "대장수", on: true }, { code: "BL034", name: "하료", on: true },
    { code: "BL020", name: "비수", on: true }, { code: "BL018", name: "간수", on: true },
    { code: "BL021", name: "위수", on: true }, { code: "BL013", name: "폐수", on: true },
    { code: "BL026", name: "관원수", on: true }, { code: "BL024", name: "기해수", on: true },
    { code: "BL031", name: "상료", on: true }, { code: "BL023", name: "신수", on: true },
    { code: "BL032", name: "차료", on: true }, { code: "BL028", name: "방광수", on: true },
    { code: "BL033", name: "중료", on: true }, { code: "BL015", name: "심수", on: true },
    { code: "BL027", name: "소장수", on: true }, { code: "BA001", name: "척삼", on: false },
    { code: "BA002", name: "견중유", on: false }, { code: "BA003", name: "결벽렬", on: false },
    { code: "BA004", name: "하백로", on: false }, { code: "BA005", name: "백종품", on: false },
    { code: "BA006", name: "정천(1)", on: false }, { code: "BA007", name: "치천", on: false },
    { code: "BA008", name: "외정천", on: false }, { code: "BA009", name: "평천", on: false },
  ],
};
...
const SECTIONS = [
  ...
  { id: "acupoints", icon: "target",       label: "상용 혈자리 설정",   roles: ["원장", "데스크"],        group: "운영" },
...
Object.assign(window, {
  ...
  INS_MEDS, INS_MEDS_USED, ACUPOINT_REGIONS, ACUPOINTS,

...
const RC_TODAY_ITEMS = {
  1: { // 박지영 — 4세대, 자보 진행 중
    ...
    items: [
      { code: "AA154", name: "한방 초진찰료",         amount: 7900,  type: "급여", claimable: true,  reason: "급여 항목 — 본인부담분 청구 가능" },
      { code: "40010", name: "체침술",                amount: 10200, type: "급여", claimable: true,  reason: "급여 항목" },
      { code: "40020", name: "전기침술",              amount: 12800, type: "급여", claimable: true,  reason: "급여 항목" },
      { code: "40070", name: "부항술 (건식)",          amount: 5500,  type: "급여", claimable: true,  reason: "급여 항목" },
      { code: "AC130", name: "구술 (간접구)",          amount: 3800,  type: "급여", claimable: true,  reason: "급여 항목" },
      { code: "NB-08", name: "약침 (자하거)",          amount: 22000, type: "비급여", claimable: false, reason: "4세대 — 한방 비급여 보장 제외" },
      { code: "NB-12", name: "추나치료 (단순)",        amount: 18000, type: "급여", claimable: true,  reason: "급여 — 본인부담 50% 환급 대상" },
    ],
    totalAmount: 80200,
  ...
  2: { // 홍길동 — 3세대
    ...
    items: [
      { code: "AA154", name: "한방 재진찰료",          amount: 5600,  type: "급여", claimable: true, reason: "급여 항목" },
      { code: "40010", name: "체침술",                amount: 10200, type: "급여", claimable: true, reason: "급여 항목" },
      { code: "40080", name: "부항술 (습식)",          amount: 7200,  type: "급여", claimable: true, reason: "급여 항목" },
    ],
  ...
  4: { // 송재호 — 4세대, 자보
    ...
    items: [
      { code: "AA154", name: "한방 초진찰료",          amount: 7900,  type: "급여", claimable: true, reason: "본인부담분 청구 가능" },
      { code: "40010", name: "체침술",                amount: 10200, type: "급여", claimable: true, reason: "급여 항목" },
      { code: "40070", name: "부항술",                amount: 5500,  type: "급여", claimable: true, reason: "급여 항목" },
      { code: "NB-21", name: "도수치료 / 추나",        amount: 35000, type: "급여", claimable: true, reason: "도수·추나 — 4세대 특약 보장 (한도 50회/년)" },
      { code: "NB-08", name: "약침 (봉약침)",          amount: 28000, type: "비급여", claimable: false, reason: "4세대 — 한방 비급여 보장 제외" },
    ],
  ...
  6: { // 박지현 — 1세대 (구실손, 비급여 포함 보장)
    ...
    items: [
      { code: "AA154", name: "한방 재진찰료",          amount: 5600,  type: "급여", claimable: true, reason: "급여 항목" },
      { code: "40010", name: "체침술",                amount: 10200, type: "급여", claimable: true, reason: "급여 항목" },
      { code: "NB-08", name: "약침 (봉약침)",          amount: 28000, type: "비급여", claimable: true, reason: "1세대 — 한방 비급여 포함 보장 ✓" },
  ...
  8: { // 오세훈
    ...
    items: [
      { code: "AA154", name: "한방 초진찰료",          amount: 7900,  type: "급여", claimable: true, reason: "급여 항목" },
      { code: "40010", name: "체침술",                amount: 10200, type: "급여", claimable: true, reason: "급여 항목" },
      { code: "40070", name: "부항술",                amount: 5500,  type: "급여", claimable: true, reason: "급여 항목" },
    ],
  ...
  10: { // 장우성 — 자보 사고
    ...
    items: [
      ...
      { code: "40010", name: "체침술",                amount: 10200, type: "급여", claimable: true, reason: "급여 항목" },
      { code: "40070", name: "부항술",                amount: 5500,  type: "급여", claimable: true, reason: "급여 항목" },
      { code: "NB-21", name: "추나치료 (복합)",        amount: 32000, type: "급여", claimable: true, reason: "도수·추나 특약 보장" },
    ],
  ...
  11: { // 안세영
    ...
    items: [
      ...
      { code: "40010", name: "체침술",                amount: 10200, type: "급여", claimable: true, reason: "급여 항목" },
      { code: "40070", name: "부항술",                amount: 5500,  type: "급여", claimable: true, reason: "급여 항목" },
      { code: "NB-21", name: "추나치료 (단순)",        amount: 18000, type: "급여", claimable: true, reason: "추나 특약 보장" },
    ],
